...
Create a landing page for a haridresser salsing.
...
Make sure you utilize whitespace **very** generously to prevent clutter. Add plenty of white space there is around elements on the screen and don’t be afraid about having the user scroll, 
...
```sh
git clone https://github.com/GPT-Engineer-App/clean-shear-landing.git
cd clean-shear-landing
npm i
```
